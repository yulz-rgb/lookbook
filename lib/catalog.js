...
export const defaultLooks = [
  {
    id: 'arrival-look',
    name: 'Arrival / Guest Welcome',
    description: 'Smart, fresh first-impression look for guest arrival and dockside welcome.',
    bodyType: 'woman',
    productIds: ['shirt-linen-white', 'skort-navy', 'shoe-service-beige', 'belt-tan'],
  },
  {
    id: 'day-deck-look',
    name: 'Day Deck Look',
...
export const defaultCrew = [
  { id: 'crew-1', name: 'Captain', role: 'captain', bodyType: 'man', topSize: 'L', bottomSize: '34', shoeSize: '43', assignedLook: 'arrival-look' },
  { id: 'crew-2', name: 'Chief Stew', role: 'chief-stew', bodyType: 'woman', topSize: 'S', bottomSize: '36', shoeSize: '38', assignedLook: 'evening-service-look' },
  { id: 'crew-3', name: 'Stew 1', role: 'interior', bodyType: 'woman', topSize: 'M', bottomSize: '38', shoeSize: '39', assignedLook: 'arrival-look' },
  { id: 'crew-4', name: 'Deckhand 1', role: 'deck', bodyType: 'man', topSize: 'M', bottomSize: '32', shoeSize: '42', assignedLook: 'day-deck-look' },
];
