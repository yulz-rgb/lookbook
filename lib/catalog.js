...
export const defaultCrew = [
  { id: 'crew-1', name: 'Emma J.', role: 'chief-stew', bodyType: 'woman', topSize: 'S', bottomSize: '36', shoeSize: '38', assignedLook: 'arrival-look' },
  { id: 'crew-2', name: 'Lily M.', role: 'interior', bodyType: 'woman', topSize: 'M', bottomSize: '38', shoeSize: '39', assignedLook: 'arrival-look' },
  { id: 'crew-3', name: 'Sophie R.', role: 'interior', bodyType: 'woman', topSize: 'S', bottomSize: '36', shoeSize: '37', assignedLook: 'evening-service-look' },
  { id: 'crew-4', name: 'James T.', role: 'deck', bodyType: 'man', topSize: 'L', bottomSize: '34', shoeSize: '43', assignedLook: 'day-deck-look' },
  { id: 'crew-5', name: 'Marcus H.', role: 'deck', bodyType: 'man', topSize: 'M', bottomSize: '32', shoeSize: '42', assignedLook: 'day-deck-look' },
  { id: 'crew-6', name: 'Captain', role: 'captain', bodyType: 'man', topSize: 'L', bottomSize: '34', shoeSize: '43', assignedLook: 'arrival-look' },
];
