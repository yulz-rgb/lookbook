...
// New workspaces start clean. The supplier catalogue remains available, but
// no fictitious yacht, crew member, sizing, look or purchase-order data is seeded.
export const vessels = ['Untitled yacht'];
