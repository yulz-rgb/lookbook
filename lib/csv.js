...
export function buildPackingListCsv({ crew, looks, products, settings, vessel }) {
  ...
  for (const list of lists) {
    ...
    out.push(['Look', 'Product', 'Category', 'Size', 'Colour', 'Sets', 'Confirmed', 'Fit notes', 'Alterations']);
...
export function buildSupplierBreakdownCsv({ crew, looks, products, settings, vessel }) {
  ...
  groups.forEach((group, i) => {
    ...
    out.push(['Product', 'Category', 'Colour', 'Size', 'Unit Price', 'Order Qty', 'Min Order', 'Meets MOQ', 'Line Total']);
